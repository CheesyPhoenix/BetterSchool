	...
	{:else if $isMobile == true}
		...
		{#if menuOpen}
			...
			<div
				...
				in:fade
				out:fade
				class="fixed z-10 top-0 left-0 w-screen h-[120vh] bg-black bg-opacity-80 backdrop-blur-sm"
			>
				<div
					class="max-w-md m-auto flex justify-start pt-36 flex-col h-full gap-2 p-4"
				>
					<a
						href="/"
